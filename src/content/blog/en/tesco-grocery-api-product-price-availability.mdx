...
description: "Using the Tesco Data API for grocery price intelligence - endpoint walkthrough, schema notes, and the patterns that hold up under real load."
...
See also: <a href="/ecommerce-data/grocery/">UK grocery API guide</a> for a full overview of the available endpoints and dataset options.
